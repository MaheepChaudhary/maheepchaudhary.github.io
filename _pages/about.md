...
<p style="font-size: 1.05em; margin-bottom: 22px; line-height: 1.65; color: #34495e; font-family: 'Poppins', sans-serif;">Previously, I have collaborated with <a href="https://atticusg.github.io" style="color: #3498db; text-decoration: none; font-weight: 500;">Atticus Geiger</a> at <a href="https://prair.group/research">Pr(Ai)<sup>2</sup>R Group</a> and <a href="https://nandischoots.com" style="color: #3498db; text-decoration: none; font-weight: 500;">Nandi Schoots</a> on mechanistic (causal) interpretability; and <a href="https://haohanwang.github.io" style="color: #3498db; text-decoration: none; font-weight: 500;">Haohan Wang</a> at UIUC on trustworthy machine learning, and completed my <strong style="color: #000000ff;">master's at NTU Singapore</strong>. Before diving deep into AI safety research, I won the Smart India Hackathon with 200K+ participants and led international teams solving real-world AI problems.</p>
...
<!-- Divider for literature surveys -->

<div style="height: 2px; background: linear-gradient(90deg, transparent, #ecf0f1, transparent); margin: 50px 0;"></div>

<h3 style="font-size: 1.4em; font-weight: 700; margin: 40px 0 25px 0; color: #2c3e50; font-family: 'Poppins', sans-serif;">📑 Literature Surveys</h3>

<div style="margin: 35px 0; background: white; border-radius: 18px; overflow: hidden; border: 2px solid #ecf0f1; box-shadow: 0 6px 25px rgba(0,0,0,0.08); transition: all 0.3s ease;">
  <div style="display: flex; align-items: center; padding: 25px; gap: 25px;">
    <img src="/images/causality.png" alt="Causal Abstraction Research" style="width: 130px; height: 130px; border-radius: 14px; flex-shrink: 0; object-fit: cover; box-shadow: 0 4px 16px rgba(0,0,0,0.1);">
    <div style="flex: 1;">
      <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 8px;">
...
<div style="margin: 25px 0; background: white; border-radius: 12px; overflow: hidden; border: 1px solid #ecf0f1; box-shadow: 0 3px 15px rgba(0,0,0,0.06); transition: all 0.3s ease;">
  <div style="display: flex; align-items: center; padding: 20px; gap: 20px;">
    ...
    <div style="flex: 1; position: relative;">
      ...
      <p style="margin: 0 0 10px 0; font-size: 0.9em; color: #95a5a6; background: rgba(149, 165, 166, 0.15); display: inline-block; padding: 4px 12px; border-radius: 15px; font-weight: 600; font-family: 'Poppins', sans-serif;">📄 arXiv</p>
      <p style="margin: 0; font-size: 0.85em; color: #5d6d7e; line-height: 1.4; font-family: 'Poppins', sans-serif;">A training methodology that promotes modular cluster formation in neural networks, making models more interpretable by learning disjoint, specialized circuits.</p>
    </div>
  </div>
</div>
...
<div style="margin: 25px 0; background: white; border-radius: 12px; overflow: hidden; border: 1px solid #ecf0f1; box-shadow: 0 3px 15px rgba(0,0,0,0.06); transition: all 0.3s ease;">
  <div style="display: flex; align-items: center; padding: 20px; gap: 20px;">
    ...
    <div style="flex: 1; position: relative;">
      ...
      <p style="margin: 0 0 10px 0; font-size: 0.9em; color: #95a5a6; background: rgba(149, 165, 166, 0.15); display: inline-block; padding: 4px 12px; border-radius: 15px; font-weight: 600; font-family: 'Poppins', sans-serif;">📄 arXiv</p>
      <p style="margin: 0; font-size: 0.85em; color: #5d6d7e; line-height: 1.4; font-family: 'Poppins', sans-serif;">Investigating the computational importance of punctuation tokens and reasoning patterns across layers in GPT-2, DeepSeek, and Gemma models.</p>
    </div>
  </div>
</div>
...
<p style="font-size: 1.05em; line-height: 1.65; margin-bottom: 20px; color: #34495e; font-family: 'Poppins', sans-serif;">Beyond research, I'm passionate about nurturing the next generation of AI researchers:</p>

<ul style="font-size: 1.05em; line-height: 1.65; margin-bottom: 20px; color: #34495e; font-family: 'Poppins', sans-serif; padding-left: 20px;">
  <li style="margin-bottom: 8px;"><strong>Mentored over 40+ students</strong> across multiple research programs and institutions.</li>
  <li style="margin-bottom: 8px;"><strong>Selected as mentor for UNESCO-India-Africa Program</strong> spanning 20+ countries.</li>
  <li style="margin-bottom: 8px;">Reviewed for <strong>ICML 2025</strong> Workshop and multiple <strong>NeurIPS 2024</strong> workshops.</li>
</ul>
